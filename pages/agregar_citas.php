        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                   ...
                   <button class="btn btn-sm btn-danger shared" <?php if (!isset($_GET["cita"])){echo "style=\"display:none;\"";}?> title="Eliminar" onclick="eliminar_cita()"><i class="fa fa-trash fa-bg"></i></button>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8 my-3"> 
                                ...
                                <div id="div_par" class="form-row" >
                                    ...
                                    <div class="form-group col-5 col-sm-5 col-md-5">
                                        <small><strong><label for=name_>Fecha Fin</label></strong></small>
                                        <input id="fecha_b" disabled="true" id="fecha_feriado" type="text" class="form-control" value="" placeholder="Seleccione una fecha del caldendario" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])">                                        
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function enviar_formulario(){
            ...
            //Comprobamos las fechas
             if ((!(regex.test($("#fecha_a").val())))||(!(regex.test($("#fecha_b").val())))){
                bandera = false;
...
//                        $("#hora_b").val(hora_seleccionada);
    ...
    function obtener_informacion_cita(){        
        ...
        if (1==<?php if (isset($_GET["cita"])){echo "1";}else{echo "0";}?>){                    
            ...
            {
                id_operacion : 5
                <?php if (isset($_GET["cita"])){echo ", cita:".$_GET["cita"];}?>
            },function(result){
                var respuesta = JSON.parse(result);
                if (respuesta[0].estado == 1){
                    ...
                    $("#fecha_b").val(respuesta[1].fecha_fin);
                    $("#fecha_a").val(respuesta[1].fecha_inicio);
