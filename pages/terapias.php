    ...
    <?php include_once("../assets/includes/menu.php") ?>
        ...
        <input type="hidden" id="hash" name="hash" value="<?php echo $hash ?>">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Lista de Terapias</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                <div class="col-lg-12 text-right pull-right">
                   <a class="btn btn-sm btn-success shared" href="agregar_terapia.php" title="Agregar"><i class="fa fa-plus-circle fa-bg"></i></a>
                </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 mx-4">
                        <?php include_once("terapias/lista_terapias.php") ?>
                    </div>
            </div>
            <!-- /.container-fluid -->
        </div>
