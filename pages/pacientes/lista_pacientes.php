			...
			foreach ($datos as $particulares) {
				...
				$lista .= ' <tr">
                            ...
                            <td class="center text-center pull-center" style="width: 30%">
                                ...
                                <a class="btn btn-sm btn-warning shared" href="programas_terapeuticos_paciente.php?id='.$particulares["id_paciente"].'" title="Programa Terapuetico" '.$disabled.'><i class="fa fa-group fa-bg" ></i></a>
