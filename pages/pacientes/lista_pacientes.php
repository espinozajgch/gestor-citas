			...
			foreach ($datos as $particulares) {
				...
				$lista .= ' <tr id="'.  $particulares['id_paciente'] .'">
                            ...
                            <td class="center text-center pull-center" style="width: 30%">
                                ...
                                <a class="btn btn-sm btn-success shared" href="agregar_citas.php?rut_paciente='.$particulares["RUT"].'" title="Agengar Cita"><i class="fa fa-calendar fa-bg"></i></a>
                                <a class="btn btn-sm btn-warning shared" href="terapias.php?opcion=1&rut_paciente='.$particulares["RUT"].'" title="Programa Terapuetico"><i class="fa fa-group fa-bg"></i></a>
