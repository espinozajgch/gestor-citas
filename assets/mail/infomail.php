<?php
	...
	class Infomail{
		...
		/**
		retorna el email de contacto
		*/
		public static function obtener_email_contacto($bd){
			
			$consulta = "SELECT email_contacto FROM web_info";
		...
		public static function obtener_email_soporte($bd){
			
			$consulta = "SELECT email_soporte FROM web_info";
		...
		public static function agregar_mensajes_soporte($bd, $mensaje, $id_soporte, $id_admin)
		{
			// Sentencia INSERT
			$consulta = "INSERT INTO mensajes_soporte (mensaje, id_soporte, id_admin) VALUES (?,?,?)";

		   try {
				// Preparar la sentencia
				$comando = $bd->prepare($consulta);
				$resultado = $comando->execute(array($mensaje, $id_soporte, $id_admin));
		...
		public static function obtener_cuerpo($bd, $titulo, $usuario, $mensaje, $pie, $extra, $extra2){
			...
			* { font-family: Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif; }
			...
			<tr>
				<td style='margin:0; padding:0; text-align: center;'><img src='https://www.buscahogar.com.ar/img/desing/logo.png' width='300px' height='auto'/>
				</td>
			</tr>
			</table>
			<!-- /HEADER -->
			...
			<!-- Callout Panel -->
					<p style='margin:0; line-height:1.6; padding:15px; background-color:#fff; margin-bottom:15px; text-align:center;' >
						<a href='https://www.buscahogar.com.ar/' style='font-family:Helvetica Neue, Helvetica,  sans-serif; font-weight:bold; color:#006699; text-align:center; text-decoration: none; font-size:24px;'>". $pie ."</a>
					</p>
			<!-- /Callout Panel -->					
